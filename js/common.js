window.addEventListener("load", function(){
  ...
  // iTyped
  ============================ */
  if (document.querySelector("#ityped-footer")) {
    var options = {
      strings: itype_text,
      typeSpeed: 100,
      backSpeed: 50,
  ...
  if (document.querySelector("#ityped-modal")) {
    var options = {
      strings: itype_text,
      typeSpeed: 100,
      backSpeed: 50,
  ...
  ============================ */
  const btnCopyToClipboard = document.querySelector("#copy-to-clipboard");

  btnCopyToClipboard.addEventListener("click", function () {
    const textToCopy = 'contact@mathishammel.com';
    ...
    const copyMessage = document.getElementById('copy-to-clipboard');
  ...
  /* ============================
  // Copy email to clipboard FOOTER
  ============================ */
  const btnCopyToClipboardFooter = document.querySelector("#copy-to-clipboard-footer");

  btnCopyToClipboardFooter.addEventListener("click", function () {
    const textToCopy = 'contact@mathishammel.com';
    ...
    // Show the "Copied!" message
    const copiedMessage = document.getElementById('copied-to-clipboard-footer');
    const copyMessage = document.getElementById('copy-to-clipboard-footer');
